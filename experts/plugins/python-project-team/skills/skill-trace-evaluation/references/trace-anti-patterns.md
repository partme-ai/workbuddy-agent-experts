...
> **来源声明：** 本文档来源于 [skill-trace-checker](skills/base-skills/skill-trace-checker/references/anti-patterns.md) by 东四联周博远。
...
第3层（深度参考）：
  - references/ 目录：scoring-criteria.md, calibration-guide.md, trace-anti-patterns.md 等
```
