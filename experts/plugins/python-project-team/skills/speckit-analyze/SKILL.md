...
description: Perform a non-destructive cross-artifact consistency and quality analysis across spec.md, plan.md, and tasks.md after task generation。适用于需要按 Spec Kit 工作流执行该步骤的场景（基于 GitHub Spec Kit 官方模板）。
license: MIT
---
