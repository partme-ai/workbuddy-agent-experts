# Handling Responses — Full Reference (Unirest 3.x)

Complete guide to handling HTTP responses with Unirest-Java 3.x.
...
GSON is included by default — no extra dependency needed:
