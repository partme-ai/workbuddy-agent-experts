# {{PRODUCT_NAME}} PRD 文档（{{VERSION}}）

> **标准说明**：本文由 原「PRD」阶段模板全文 全文合并。
>
> **职责边界**：本文件负责版本目标、范围、跨模块规则和统一验收口径；模块内部的页面、状态、字段与局部验收细节写入模块 PRD，避免两处维护相同正文。详见 [`document-boundaries.md`](../../references/document-boundaries.md)。

### 关联文档（产品 / 组织）

| 文档 | 说明 |
| :--- | :--- |
| `1、{{PRODUCT_NAME}}-需求调研文档-{{VERSION}}.md` | 需求调研 |
| `2、{{PRODUCT_NAME}}-需求分析文档-{{VERSION}}.md` | 需求分析 |
| `3、{{PRODUCT_NAME}}-{{VERSION}}-Architecture.zh_CN.md` | 版本架构 |
| `4、{{PRODUCT_NAME}}-功能与界面规划-{{VERSION}}.md` | 功能与界面规划 |
| `6、{{PRODUCT_NAME}}-功能菜单与版本规划-{{VERSION}}.md` | 本版功能菜单 |
| `7、{{PRODUCT_NAME}}-UI设计说明-{{VERSION}}.md` | UI 设计说明 |
| `其他/1、技术细分模板.md` 或研发仓库 | 接口/表结构细节 |
...
| 文档类型 | 文档名称 | 版本 | 说明 |
| :--- | :--- | :--- | :--- |
| 技术文档 | `其他/1、技术细分模板.md` 或研发仓库 | V1.0.0 | 技术实现方案 |
| UI设计稿 | 设计稿链接 | V1.0 | Figma/Sketch设计文件 |
...
- `2、{{PRODUCT_NAME}}-需求分析文档-{{VERSION}}.md`
- `9、{{PRODUCT_NAME}}-视觉与交互DNA规范.md`
- `7、{{PRODUCT_NAME}}-UI设计说明-{{VERSION}}.md`
- `其他/1、技术细分模板.md`
