...
description: Execute the implementation plan by processing and executing all tasks defined in tasks.md。适用于需要按 Spec Kit 工作流执行该步骤的场景（基于 GitHub Spec Kit 官方模板）。
license: MIT
---
