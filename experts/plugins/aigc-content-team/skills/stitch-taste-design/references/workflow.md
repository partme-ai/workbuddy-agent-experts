...
**Style proposal defaults (user-approved brand values take precedence):**
- Maximum 1 accent color. Saturation below 80%
- For this optional proposal style, avoid the "AI Purple/Blue Neon" aesthetic unless required by the approved brand — no purple button glows, no neon gradients
...
- **Mobile-First Collapse (< 768px):** Collapse content according to readable task structure; dense tables may use an explicitly designed scroll region
- **No Horizontal Scroll:** Horizontal overflow on mobile is a critical failure
- **Typography Scaling:** Headlines scale via `clamp()`. Body text minimum `1rem` (resolve actual root font size; do not equate it with 14px)`
...
Purposeful finite feedback and a reduced-motion alternative. Hardware-accelerated
