...
- Output: "Please finish the three-step setup on the page that just opened. Paste the Token only into the password field; once it is saved, reopen the host application and I will continue with the original architecture diagram request."
...
- Output: "The ProcessOn credential is invalid or expired. I have opened the local update page; after saving the new Token and reopening the host application, I will continue with this diagram."
