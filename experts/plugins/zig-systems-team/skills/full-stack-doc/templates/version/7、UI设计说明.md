# {{PRODUCT_NAME}} UI 设计说明（{{VERSION}}）

> **标准说明**：本文由 原「UI 设计说明」阶段模板全文 全文合并（版本级总说明）。
>
> **职责边界**：本文件冻结版本级设计系统、全局布局、导航、通用组件和跨页面交互规则；模块页面的局部布局、状态与切图说明写入模块 UI 文档。详见 [`document-boundaries.md`](../../references/document-boundaries.md)。

### 关联文档（产品 / 组织）

| 文档 | 说明 |
| :--- | :--- |
| `../9、{{PRODUCT_NAME}}-视觉与交互DNA规范.md` | 全局 DNA |
| `5、{{PRODUCT_NAME}}-PRD文档-{{VERSION}}.md` | PRD |
| `2、{{PRODUCT_NAME}}-需求分析文档-{{VERSION}}.md` | 需求分析 |
| 模块目录 `*-UI设计说明-{{VERSION}}.md` | 模块细稿 |
...
| :--- | :--- | :--- | :--- | :--- |
| V1.0.0 | {{DATE}} | {{OWNER}} | 初始版本 | 对应设计稿 V1.0 |

### 1.2 文档责任人
| 角色 | 姓名 | 职责 |
| :--- | :--- | :--- |
| UI设计师 | {{OWNER}} | UI设计、交互设计、设计规范输出 |
| 产品经理 | {{OWNER}} | 需求确认、设计评审 |
| 前端开发 | {{OWNER}} | 设计实现、设计还原度把控 |

### 1.3 关联文档
| 文档类型 | 文档名称 | 版本 | 说明 |
| :--- | :--- | :--- | :--- |
| 需求分析文档 | `2、{{PRODUCT_NAME}}-需求分析文档-{{VERSION}}.md` | V1.0.0 | 功能需求和用户故事 |
| UI设计稿 | {{PRODUCT_NAME}}-UI设计稿 | V1.0 | Figma/Sketch设计文件 |
| 原型图 | {{PRODUCT_NAME}}-原型图 | V1.0 | 交互原型文件 |
| DNA规范 | `../9、{{PRODUCT_NAME}}-视觉与交互DNA规范.md` | V1.0.0 | 设计DNA规范 |
...
本文档遵循《9、{{PRODUCT_NAME}}-视觉与交互DNA规范》，包括：
- 色彩系统
- 字体系统
- 间距系统
- 圆角系统
...
**详细规范请参考**：`../9、{{PRODUCT_NAME}}-视觉与交互DNA规范.md`
