> **标准说明**：以下为 原「UI 设计说明」阶段模板全文 **全文**。
>
> **职责边界**：本文件描述当前模块的页面、组件、状态、响应式与交付细节；全局设计令牌、导航和通用组件以版本 UI 与根级视觉 DNA 为准，不在本文件复制维护。

---

# {{PRODUCT_NAME}}-{{MODULE_NAME}}-UI设计说明（{{VERSION}}）
...
| 文档类型 | 文档名称 | 版本 | 说明 |
| :--- | :--- | :--- | :--- |
| 需求分析文档 | {{PRODUCT_NAME}}-需求分析文档.md | V1.0.0 | 功能需求和用户故事 |
| UI设计稿 | {{PRODUCT_NAME}}-UI设计稿 | V1.0 | Figma/Sketch设计文件 |
| 原型图 | {{PRODUCT_NAME}}-原型图 | V1.0 | 交互原型文件 |
| DNA规范 | {{PRODUCT_NAME}}-视觉与交互DNA规范.md | V1.0.0 | 设计DNA规范 |
...
本文档遵循《{{PRODUCT_NAME}}-视觉与交互DNA规范》，包括：
- 色彩系统
- 字体系统
- 间距系统
- 圆角系统
...
**详细规范请参考**：[视觉与交互 DNA 规范](../../9、{{PRODUCT_NAME}}-视觉与交互DNA规范.md)
