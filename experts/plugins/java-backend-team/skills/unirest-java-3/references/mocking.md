# Mocking — Full Reference (Unirest 3.x)

Complete guide to mocking HTTP calls with Unirest-Java 3.x for unit testing.
...
The mock framework uses the configured ObjectMapper (GSON by default) to serialize POJOs:
